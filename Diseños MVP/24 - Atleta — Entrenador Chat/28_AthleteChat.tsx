/**
 * 28 — Atleta — Chat con el Coach
 * Pantalla: Atleta
 * Descripción: Chat directo del atleta con su coach. Mensajes en tiempo real,
 * burbuja de coach a la izquierda y atleta a la derecha.
 */
...
export default function AthleteChatScreen({ navigation }: Props) {
...
const styles = StyleSheet.create({
  ...
  dateSep: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 4 },
  ...
  bubble: { borderRadius: 16, paddingHorizontal: 12, paddingVertical: 10, maxWidth: 220 },
  bubbleLeft: {
